...
public class EstimationController {
    ...
    public List<EstimationDto> findPage(@RequestParam boolean adminView) {

        return this.beanMapper.mapList(this.estimationService.findAll(adminView), EstimationDto.class);
    }
