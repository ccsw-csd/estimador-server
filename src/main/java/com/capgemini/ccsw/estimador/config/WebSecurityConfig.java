...
import com.capgemini.ccsw.estimador.config.security.JsonWebTokenAuthenticationFilter;
import com.capgemini.ccsw.estimador.config.security.JsonWebTokenAuthenticationProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void setupAuthorization(HttpSecurity http) throws Exception {
    ...
    String[] unsecuredResources = new String[] { "/", "/public/**" };
